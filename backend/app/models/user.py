...
class User(Base):
    ...
    name :Mapped[str] = mapped_column(String(50),comment="用户名",nullable=False)
    role :Mapped[str] = mapped_column(String(50),comment="角色：student-学生,admin-管理员",nullable=False)
